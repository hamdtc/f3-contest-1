...
function Race100M(score, LongJump){
    setTimeout(() => {
        console.log("starting score board: ");
        console.log(score);
        const obj = {
        ...
        console.log("Winner 100 Meter race: " + sortedArr[0]);
...
function LongJump(score, HighJump){
    setTimeout(() => {
        ...
        if(i == 1){
            ...
            val += 150;
            score.red = val;
            console.log("Winner in LongJump : " + "red");
        ...
        if(i == 2){
            ...
            val += 150;
            score.blue = val;
            console.log("Winner in LongJump : " + "blue");
            console.log("Updated Score");
            console.log(score);
        }
        if(i == 3){
            ...
            val += 150;
            score.green = val;
            console.log("Winner in LongJump : " + "green");
            console.log("Updated Score");
            console.log(score);
        }
        if(i == 4){
            ...
            val += 150;
            score.yellow = val;
            console.log("Winner in LongJump : " + "yellow");
            console.log("Updated Score");
            console.log(score);
        }
